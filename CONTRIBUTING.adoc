...
defiant/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
...
suite (Perimeter 2-3) ├── .well-known/ # Protocol files (Perimeter 1-3)
...
README.adoc ├── SECURITY.md ├── flake.guix # Guix flake (Perimeter 1)
